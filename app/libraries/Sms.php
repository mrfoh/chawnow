...
class Sms {
	...
	public function __construct($callback = 1) {

		$this->username = Config::get('sms.login');
		$this->password = Config::get('sms.password');
		$this->appid = Config::get('sms.app_id');
		$this->sender = "Chawnow";
	 ...
	 * @return string
	 */
	public function sendMessage($myRecipients, $myMessage, $flash = 0, $countrycode=null, $messageid=null) 
	{
