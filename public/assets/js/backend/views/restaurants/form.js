Backend.Views.RestuarantFormView = Backbone.View.extend({
	el: "#app",
	...
	initUploader: function() {
		...
		var uploader = new plupload.Uploader({
			...
			url: Backend.Constants.url+"/upload",
			max_file_size: '1mb',
			filters : [
			 { title : "Image files", extensions : "jpg,gif,png"}
			],
			flash_swf_url : Backend.Constants.url+"/js/plugins/plupload/Moxie.swf",
			unique_names: true,
			file_data_name: 'logo'
		});
